...
namespace GrblConnector.Tests
{
    ...
    public class NmeaMessages
    {
		...
		public void TestGpgga()
		{
			...
			Assert.AreEqual(GrblConnector.Nmea.Gps.Gpgga.FixQuality.GpsFix, gga.Quality);
		...
		public void TestPtlna()
		{
			...
			var msg = NmeaMessage.Parse(input);
			Assert.IsInstanceOfType(msg, typeof(GrblConnector.Nmea.LaserRange.Trimble.Ptnla));
			GrblConnector.Nmea.LaserRange.Trimble.Ptnla ptlna = (GrblConnector.Nmea.LaserRange.Trimble.Ptnla)msg;
		...
		public void TestPgrme()
		{
			...
			var msg = NmeaMessage.Parse(input);
			Assert.IsInstanceOfType(msg, typeof(GrblConnector.Nmea.Gps.Garmin.Pgrme));
			GrblConnector.Nmea.Gps.Garmin.Pgrme rme = (GrblConnector.Nmea.Gps.Garmin.Pgrme)msg;
		...
		public void TestPgrmz_Empty()
		{
			...
			var msg = NmeaMessage.Parse(input);
			Assert.IsInstanceOfType(msg, typeof(GrblConnector.Nmea.Gps.Garmin.Pgrmz));
			var rmz = (GrblConnector.Nmea.Gps.Garmin.Pgrmz)msg;
			Assert.AreEqual(double.NaN, rmz.Altitude, "Altitude");
			Assert.AreEqual(GrblConnector.Nmea.Gps.Garmin.Pgrmz.AltitudeUnit.Unknown, rmz.Unit, "Unit");
			Assert.AreEqual(GrblConnector.Nmea.Gps.Garmin.Pgrmz.PositionFixType.Unknown, rmz.FixType, "FixDimension");
		}
		...
		public void TestPgrmz()
		{
			...
			Assert.AreEqual(GrblConnector.Nmea.Gps.Garmin.Pgrmz.AltitudeUnit.Feet, rmz.Unit, "Unit");
			Assert.AreEqual(GrblConnector.Nmea.Gps.Garmin.Pgrmz.PositionFixType.Fix3D, rmz.FixType, "FixDimension");
		}
		...
		public void TestGprte()
		{
			...
			Assert.AreEqual(1, gsv.MessageNumber);
			Assert.AreEqual(GrblConnector.Nmea.Gps.Gprte.WaypointListType.CompleteWaypointsList, gsv.ListType);
