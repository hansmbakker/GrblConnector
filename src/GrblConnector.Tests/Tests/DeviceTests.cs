...
//			GrblDevice dev = new BufferedStringDevice(message);
...
//					Assert.IsInstanceOfType(e.Message, typeof(GrblConnector.Nmea.Gps.Gpgsv));
//					var msg = e.Message as GrblConnector.Nmea.Gps.Gpgsv;
